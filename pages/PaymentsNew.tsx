      ...
      <Box bg="white" rounded="2xl" p={{ base: 6, lg: 10 }} shadow="sm">
        ...
        <Flex justify="space-between" align="flex-start" mb={10} wrap="wrap" gap={6}>
          ...
          <Box textAlign="right">
            ...
            <Text fontWeight="bold" fontSize="3xl" color="#0052EA">NGN 5000</Text>
          </Box>
        </Flex>
        ...
        <Grid templateColumns={{ base: "1fr", md: "280px 1fr" }} gap={0} bg="#F8FAFC" rounded="xl" overflow="hidden" border="1px" borderColor="gray.100">
          ...
          <GridItem bg="white" p={{ base: 6, lg: 12 }}>
            <Flex justify="space-between" mb={10} align="center">
              ...
              <Text fontSize="sm" color="green.500" fontWeight="bold">Pay NGN 5000</Text>
            </Flex>
            ...
            <VStack spacing={8} maxW="500px" mx="auto">
              ...
              <Button w="full" bg="#4ADE80" _hover={{ bg: '#22c55e' }} color="white" size="lg" h="56px" fontSize="md" fontWeight="bold" rounded="lg" mt={4} onClick={() => { alert('Payment Successful!'); navigate('/payments'); }}>
                Pay NGN 5000
              </Button>
            </VStack>
          </GridItem>
